...
use constant ID_LOAD_STATEMENT => "SELECT * FROM human_pathway_kegg WHERE id=?";

use constant GENE_LOAD_STATEMENT => "SELECT id FROM human_pathway_kegg WHERE gene=?";
...
#print "criteria : $criteria \n";
	    carp "Initializing human_pathway_kegg : unexpected number of records = ",$select->rows,"\n";
	}
    }
}
