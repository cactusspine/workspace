...
use constant ID_LOAD_STATEMENT => "SELECT * FROM mouse_gene_name WHERE id=?";

use constant GENE_LOAD_STATEMENT => "SELECT * FROM mouse_gene_name WHERE gene=?";
